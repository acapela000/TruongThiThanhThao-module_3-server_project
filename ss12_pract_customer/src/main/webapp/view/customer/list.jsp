...
<%--                        <c:out value="Female"/>--%>Female
                    ...
                    <td>
                        ...
                        <button onclick="deleteCustomer('${customer.id}','${customer.name}')" type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#deleteCustomer">
                            DELETE
                        </button>
